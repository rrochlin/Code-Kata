...
namespace delete_occourances_over_n
{
    class Program
    {
        public static int[] DeleteNth(int[] arr, int x)
        {
            ...
            Dictionary<int, int> new_dict = arr.Distinct().ToArray().ToDictionary(key => key, value => 0);
        ...
        static void Main(string[] args)
        {
            ...
            expected = new int[] { 1, 1, 3, 3, 7, 2, 2, 2 };
            actual = DeleteNth(new int[] { 1, 1, 3, 3, 7, 2, 2, 2, 2 }, 3);
            Console.WriteLine(expected == actual);
        }
    }
}
